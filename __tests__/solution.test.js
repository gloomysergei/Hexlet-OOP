...
import Segment from "../src-06/Segment.js";
import Point from "../src-06/Point.js";
import reverse from "../src-06/solution.js";
...
test("reverse", () => {
  ...
  expect(JSON.stringify(reversedSegment.getBeginPoint())).toEqual(
    JSON.stringify(point2)
  );
  expect(JSON.stringify(reversedSegment.getEndPoint())).toEqual(
